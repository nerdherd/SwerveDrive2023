    ...
    public void reportToSmartDashboard(LOG_LEVEL level) {
        ...
        switch (level) {
            ...
            case ALL:
                ...
                SmartDashboard.putNumber("Drive Motor #" + driveMotorID + " Voltage", driveMotor.getSupplyVoltage().getValue());// getMotorOutputVoltage());
                SmartDashboard.putNumber("Turn Motor #" + turnMotorID + " Voltage", turnMotor.getSupplyVoltage().getValue()); //getMotorOutputVoltage
